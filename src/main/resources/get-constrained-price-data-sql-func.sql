create function get_constrained_price_data(bas text[], v_id text) returns json
    language plpgsql
as
$$
DECLARE
...
alter function get_constrained_price_data(bas text[], v_id text) owner to qwep_price;